...
func main() {
	...
	newClient := Client{
		FIO:      "Abramov Max",         // укажите ФИО
		Login:    "gobpo2002",           // укажите логин
		Birthday: "18.02.2002",          // укажите день рождения
		Email:    "gobpo2002@gmail.com", // укажите почту
	}
	...
	newLogin := "NEW LOGIN" // укажите новый логин
